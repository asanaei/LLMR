...
We will show both unstructured and structured pipelines, using four
model names: - gpt-5-nano (OpenAI) - claude-sonnet-4-20250514
(Anthropic) - gemini-2.5-flash (Gemini) - openai/gpt-oss-20b (Groq)

You will need environment variables OPENAI_API_KEY, ANTHROPIC_API_KEY,
...
You can now enable structured output directly in
...
and supports all the same shorthand syntax.
