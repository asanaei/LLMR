...
df_s <- df |>
  llm_mutate_structured(
    the_annotation = "Identify an object and the attitude expressed toward thar object 
...
This example is written without using the structured ouput functionality for
...
it is always better to spcify this: `embedding = TRUE`.
