...
vignette: >
  %\VignetteIndexEntry{parallel_calls}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
  %\DontRun
---

A few years ago, it was found that some automated resume processors had positive 
bias toward the name 'Jared.' In this example we want to call a large language 
model multiple times with various temperatures and see the results.
