...
- **OpenAI-compatible (OpenAI, Groq, Together, x.ai, DeepSeek)**  
  ...
  See [OpenAI API overview](https://platform.openai.com/docs/overview), [Groq API (OpenAI-compatible)](https://console.groq.com/docs/text-chat), [Together: OpenAI compatibility](https://docs.together.ai/docs/openai-compatibility), [x.ai: OpenAI API schema](https://docs.x.ai/docs/getting-started), [DeepSeek: OpenAI-compatible endpoint](https://api-docs.deepseek.com/guides/chat_completions_api)
...
- **Anthropic (Claude)**  
  ...
  See [Anthropic Messages API: tools & `input_schema`](https://docs.anthropic.com/en/api/messages#tools)
...
- **Google Gemini (REST)**  
  ...
  See [Text generation (shows `responseMimeType`)](https://ai.google.dev/gemini-api/docs/text-generation?lang=ruby#generate-text), [Function calling & JSON](https://ai.google.dev/gemini-api/docs/function-calling)
...
*(Tip: if you see a 400 complaining about `required`, add **all** properties to `required`, as above.)*
...
* Anthropic: Messages API, tools & `input_schema`: [https://docs.anthropic.com/en/api/messages#body-tool-choice](https://docs.anthropic.com/en/api/messages#body-tool-choice)
