...
**What could still fail?** Proxies labeled "OpenAI-compatible" sometimes accept `response_format` but do not strictly enforce it; LLMR's parser recovers from fences or pre/post text.

---

### 2) **Schema-constrained output on Groq** (open model)
